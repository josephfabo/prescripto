...
const Appointment = () => {
  ...
  const getAvailabeSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      // Create date for each of the next 7 days
      const currentDate = new Date(today);
      currentDate.setDate(today.getDate() + i);
  
      // End time for the day (9 PM)
      ...
      if (i === 0) {
        ...
        // If before 10 AM → start at 10:00
        if (hour < 10) {
          currentDate.setHours(10, 0, 0, 0);
        } else {
          // Round hour if needed
          currentDate.setHours(hour + (minute > 30 ? 1 : 0));
          currentDate.setMinutes(minute > 30 ? 0 : 30);
        }
  
      } else {
        // Future days always start at 10:00
      ...
      // Add the generated slots for this day
